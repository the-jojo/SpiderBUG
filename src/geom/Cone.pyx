...
cdef class Cone:
    """
    Right, circular cone which opens upward and extends infinitely.
    Cone is defined by the minimum point and a gradient of the sides. The center axis of the cone
    extends upwards perpendicular to the x and y axes
    """
